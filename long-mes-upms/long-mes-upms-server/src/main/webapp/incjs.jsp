...
<!-- FastClick -->     
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/fastclick-1.0.6/lib/fastclick.js"></script>
<!-- NProgress -->     
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/nprogress-0.2.0/nprogress.js"></script>
<!-- Chart.js -->
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/Chart.js/Chart.js"></script>
<!-- gauge.js -->     
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/gauge.js-1.3.3/dist/gauge.js"></script>
<!-- bootstrap-progressbar与easyui-1.5.1中progress冲突 -->
<!-- <script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/bootstrap-progressbar-0.9.0/bootstrap-progressbar.js"></script> -->

<!-- iCheck --> 
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/icheck-1.0.2/icheck.js"></script>
<!-- Skycons -->
...
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/Datejs/build/date-zh-CN.js"></script>

<!-- JQVMap -->
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/jqvmap-1.5.1/dist/jquery.vmap.js"></script>
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/jqvmap-1.5.1/dist/maps/jquery.vmap.world.js"></script>
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/jqvmap-1.5.1/examples/js/jquery.vmap.sampledata.js"></script>
<!-- bootstrap-daterangepicker -->
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/bootstrap-daterangepicker-2.1.25/moment.js"></script>
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/bootstrap-daterangepicker-2.1.25/daterangepicker.js"></script>
<!-- pnotify-3.2.0 -->
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/pnotify-3.2.0/dist/pnotify.js"></script>
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/pnotify-3.2.0/dist/pnotify.buttons.js"></script>
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/pnotify-3.2.0/dist/pnotify.nonblock.js"></script>
...
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/jszip-3.1.3/dist/jszip.js"></script>
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/pdfmake-0.1.28/build/pdfmake.js"></script>
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/pdfmake-0.1.28/build/vfs_fonts.js"></script>
