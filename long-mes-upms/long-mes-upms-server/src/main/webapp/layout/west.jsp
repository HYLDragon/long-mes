...
<div class="easyui-accordion" data-options="fit:true,border:false">
	<div title="系统菜单" style="padding: 5px;" data-options="border:false,lines:true,isonCls:'anchor',tools : [ {
	...
	<div id="bodyMenu" title="其他示例" data-options="border:false,iconCls:'anchor'">
