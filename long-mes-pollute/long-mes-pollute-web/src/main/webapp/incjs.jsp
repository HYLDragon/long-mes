...
<script type="text/javascript"
        src="${basePath}/resources/long-mes-admin/jslib/gauge.js-1.3.3/dist/gauge.min.js"></script>
...
<!-- iCheck --> 
<script type="text/javascript" src="${basePath}/resources/long-mes-admin/jslib/icheck-1.0.2/icheck.min.js"></script>
<%--<!-- Skycons -->--%>
