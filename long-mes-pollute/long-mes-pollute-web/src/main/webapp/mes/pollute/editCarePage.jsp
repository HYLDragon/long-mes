...
<script type="text/javascript">
    $(function () {
        ...
        $('#form').form({
            url : '${pageContext.request.contextPath}/careController/edit',
            onSubmit : function() {
                $.messager.progress({
                    title : '提示',
                    text : '数据处理中，请稍后....'
    ...
    <div class="row" style="width: 98%;">
        <form class="form-horizontal" id="form" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" name="name" class="form-control" value="${care.name}" id="inputNamel3">
                </div>
            </div>
            <div class="form-group">
                <label for="inputRemark3" class="col-sm-3 control-label">详细说明</label>
                <div class="col-sm-8">
                    <input type="text" name="remark" class="form-control" value="${care.remark}" id="inputRemark3">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <select name="careTypeId" id="inputCareType" class="easyui-combobox"
                        ...
                        <option value="${care.careTypeId}">${care.careTypeName}</option>
