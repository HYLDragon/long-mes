...
<header class="main-header">
    ...
    <a href="#" class="logo">
        ...
        <span class="logo-mini"><b>H</b>YL</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Admin</b>HYL</span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">10条信息要查看</li>
                        <li>
                            <!-- inner menu: contains the actual data -->
                            <ul class="menu">
                                <li>
                                    <a href="#">
                                        <i class="fa fa-users text-aqua"></i> 今天有5条
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="${pageContext.request.contextPath}/jslib/dist/img/user2-160x160.jpg" class="user-image"
                             alt="User Image">
                        <span class="hidden-xs">${sessionInfo.name}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
